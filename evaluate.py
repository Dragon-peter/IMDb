...
def main() -> None:
    ...
    predictions = probabilities_to_labels(torch.tensor(probabilities).numpy())
    ...
    pd.DataFrame(rows).head(200).to_csv(ARTIFACTS_DIR / "sample_predictions.csv", index=False)
